 ...
 * <p> Clase UbicacionGeografica 19/6/2025.
 ...
 */
@Entity
@Table(name = "UbicacionGeografica", catalog = "PORTAL_APLICATIVOS_CJ", schema = "ADM")
@Setter
@Getter
public class UbicacionGeografica implements Serializable {
  ...
  @ManyToOne
  @JoinColumn(name = "idUbicacionGeograficaPadre")
